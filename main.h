...
#define AZUL			D3DCOLOR_ARGB(255, 0, 0, 255)
#define VERDE			D3DCOLOR_ARGB(150, 0, 255, 0)
#define LARANJA			D3DCOLOR_ARGB(200, 255, 165, 0)
#define AMARELO			D3DCOLOR_ARGB(255, 255,255,0)
#define PRETO			D3DCOLOR_ARGB(200, 0, 0 ,0 )
...
void SaveCfg()
{
	...
	//fout << "Esqueletoesp " << esqueletoesp << endl;
...
char* opt_ZeroTen[] = { (PCHAR)"< 0 >", (PCHAR)"< 1 >", (PCHAR)"< 2 >", (PCHAR)"< 3 >", (PCHAR)"< 4 >", (PCHAR)"< 5 >", (PCHAR)"< 6 >", (PCHAR)"< 7 >", (PCHAR)"< 8 >", (PCHAR)"< 9 >", (PCHAR)"< 10 >", (PCHAR)"< 11 >", (PCHAR)"< 12 >", (PCHAR)"< 13 >", (PCHAR)"< 14 >", (PCHAR)"< 15 >", (PCHAR)"< 16 >" };
char* opt_Keys[] = { (PCHAR)"< OFF >", (PCHAR)"< Shift >", (PCHAR)"< RMouse >", (PCHAR)"< LMouse >", (PCHAR)"< Ctrl >", (PCHAR)"< Alt >", (PCHAR)"< Space >", (PCHAR)"< X >", (PCHAR)"< C >" };
char* opt_aimfov[] = { (PCHAR)"< 15 >", (PCHAR)"< 30 >", (PCHAR)"< 45 >", (PCHAR)"< 60 >", (PCHAR)"< 90 >", (PCHAR)"< 180 >", (PCHAR)"< 360 >" };
//char *opt_aimfov[] = { (PCHAR)"< 0 >", (PCHAR)"< 10% >", (PCHAR)"< 20% >", (PCHAR)"< 30% >", (PCHAR)"< 40% >", (PCHAR)"< 90% >", (PCHAR)"< 180% >", (PCHAR)"< 360% >" };
char* opt_autoshoot[] = { (PCHAR)"< OFF >", (PCHAR)"< ON >" };
...
void DrawMenu(LPDIRECT3DDEVICE9 pDevice)
{
	...
	if (ShowMenu)
	{
		...
		if (esp_group) {
			...
			//AddItem(pDevice, (PCHAR)"Esqueleto Esp", shaderesp, opt_OnOff, 1);
		...
		if (aim_group) {
			...
			AddItem(pDevice, (PCHAR)"Aimsens", aimsens, opt_ZeroTen, 6);
			AddItem(pDevice, (PCHAR)"Aimfov", aimfov, opt_aimfov, 6);
			AddItem(pDevice, (PCHAR)"Aimheight", aimheight, opt_ZeroTen, 4);
			AddItem(pDevice, (PCHAR)"Preaim", preaim, opt_ZeroTen, 4);
		}
